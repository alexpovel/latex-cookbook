...
Drawing flowcharts is possible with Tikz. An example can be found in \cref{fig:flowchart_example}. The style definitions for the nodes can be found in the
acp.cls.
