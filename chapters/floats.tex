...
Note that the caption of \cref{tab:font_examples} occurs \textit{above} the table no matter the \package{caption} command's position.
...
\begin{figure}\ContinuedFloat
	...
	{%
		...
		\floatfoot{\autocite[30]{guzzella_introduction_2010}}%
	}%
	{%
		\small
		\def\svgwidth{0.6\figurewidth}
